...
void T1iTOF::T1iTOF_exampledata(int iTOF_id)
{
  ...
  for(int i=1;i<=nofBox0;i++){
    ...
    for(int j=1;j<=3;j++){
      ...
      outFile<<to_string(i)+"-"+to_string(j)<<" "<<"6"<<" "<<"4"<<" "<<"850"<<" "<<px<<" "<<py<<" "<<pz<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"11"<<endl;
      //MRPCceng
      outFile<<to_string(i)+"-"+to_string(j)+"-1"<<" "<<"0.55"<<" "<<"6"<<" "<<"850"<<" "<<"1.775"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<endl;
      outFile<<to_string(i)+"-"+to_string(j)+"-2"<<" "<<"0.25"<<" "<<"6"<<" "<<"850"<<" "<<"1.3"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<endl;
      outFile<<to_string(i)+"-"+to_string(j)+"-3"<<" "<<"0.40"<<" "<<"6"<<" "<<"850"<<" "<<"0.975"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<endl;
      outFile<<to_string(i)+"-"+to_string(j)+"-4"<<" "<<"0.25"<<" "<<"6"<<" "<<"850"<<" "<<"0.65"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<endl;
      outFile<<to_string(i)+"-"+to_string(j)+"-5"<<" "<<"0.40"<<" "<<"6"<<" "<<"850"<<" "<<"0.325"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<endl;
      outFile<<to_string(i)+"-"+to_string(j)+"-6"<<" "<<"0.25"<<" "<<"6"<<" "<<"850"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<endl;
      outFile<<to_string(i)+"-"+to_string(j)+"-7"<<" "<<"0.40"<<" "<<"6"<<" "<<"850"<<" "<<"-0.325"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<endl;
      outFile<<to_string(i)+"-"+to_string(j)+"-8"<<" "<<"0.25"<<" "<<"6"<<" "<<"850"<<" "<<"-0.65"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<endl;
      outFile<<to_string(i)+"-"+to_string(j)+"-9"<<" "<<"0.40"<<" "<<"6"<<" "<<"850"<<" "<<"-0.975"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<endl;
      outFile<<to_string(i)+"-"+to_string(j)+"-10"<<" "<<"0.25"<<" "<<"6"<<" "<<"850"<<" "<<"-1.3"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<endl;
      outFile<<to_string(i)+"-"+to_string(j)+"-11"<<" "<<"0.55"<<" "<<"6"<<" "<<"850"<<" "<<"-1.775"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<endl;
    }
