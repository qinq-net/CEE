...
T1T0::T1T0()
{
  ...
  for(int i=1;i<=nofBox0;i++){
    ...
    outFile<<"6"<<" "<<"4"<<" "<<"60"<<" "<<px<<" "<<py<<" "<<pz<<" "<<-phi_r<<" "<<"0"<<" "<<"0"<<" "<<"1"<<endl;//////
    outFile<<to_string(i)+"-1"<<" "<<"6"<<" "<<"4"<<" "<<"60"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"11"<<endl;
    outFile<<to_string(i)+"-1-1"<<" "<<"6"<<" "<<"0.55"<<" "<<"60"<<" "<<"0"<<" "<<"1.775"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<endl;
    outFile<<to_string(i)+"-1-2"<<" "<<"6"<<" "<<"0.25"<<" "<<"60"<<" "<<"0"<<" "<<"1.3"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<endl;
    outFile<<to_string(i)+"-1-3"<<" "<<"6"<<" "<<"0.40"<<" "<<"60"<<" "<<"0"<<" "<<"0.975"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<endl;
    outFile<<to_string(i)+"-1-4"<<" "<<"6"<<" "<<"0.25"<<" "<<"60"<<" "<<"0"<<" "<<"0.65"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<endl;
    outFile<<to_string(i)+"-1-5"<<" "<<"6"<<" "<<"0.40"<<" "<<"60"<<" "<<"0"<<" "<<"0.325"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<endl;
    outFile<<to_string(i)+"-1-6"<<" "<<"6"<<" "<<"0.25"<<" "<<"60"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<endl;
    outFile<<to_string(i)+"-1-7"<<" "<<"6"<<" "<<"0.40"<<" "<<"60"<<" "<<"0"<<" "<<"-0.325"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<endl;
    outFile<<to_string(i)+"-1-8"<<" "<<"6"<<" "<<"0.25"<<" "<<"60"<<" "<<"0"<<" "<<"-0.65"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<endl;
    outFile<<to_string(i)+"-1-9"<<" "<<"6"<<" "<<"0.40"<<" "<<"60"<<" "<<"0"<<" "<<"-0.975"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<endl;
    outFile<<to_string(i)+"-1-10"<<" "<<"6"<<" "<<"0.25"<<" "<<"60"<<" "<<"0"<<" "<<"-1.3"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<endl;
    outFile<<to_string(i)+"-1-11"<<" "<<"6"<<" "<<"0.55"<<" "<<"60"<<" "<<"0"<<" "<<"-1.775"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<" "<<"0"<<endl;
  }
  for(int i=1+nofBox0;i<=2*nofBox0;i++){
    outFile<<i+nofBox0<<endl;
